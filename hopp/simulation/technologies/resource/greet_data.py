...
class GREETData:
    ...
    def preprocess_greet(self):
        ...
        MJ_to_kWh = 0.278                                   # 1 MJ = (1/3.6) kWh ~= 0.2777777777777778 kWh
        ...
        # Steel
        steel_lime_EI = ((greet1['Chemicals']['BA247'].value +                                      # Lime production emissions for use in DRI-EAF Steel production (kg CO2e/kg lime)
        ...
        steel_NG_supply_EI = ((greet2['Steel']['B260'].value +                                                      # Upstream Natural Gas emissions for DRI-EAF Steel production (g CO2e/MJ)
        ...
        steel_iron_ore_EI = ((greet2['Steel']['B92'].value +                                                        # Iron ore production emissions for use in DRI-EAF Steel production (kg CO2e/kg iron ore)
        ...
        steel_H2O_EI = ((steel_NG_supply_EI * g_to_kg) / greet2['Steel']['B249'].value)                             # TODO: See GreenHEART_Notes.txt, Water consumption emissions for use in DRI-EAF Steel production (kg CO2e/gal H20)      
        ...
        steel_NG_consume = ((greet2['Steel']['AE63'].value +                                                        # TODO: See GreenHEART_Notes.txt, Natural gas consumption for DRI-EAF Steel production (GJ/ton steel)
        ...
        steel_PO_consume = (greet2['Steel']['Y108'].value * (mmbtu_to_MWh/ton_to_MT))                               # TODO: See GreenHEART_Notes.txt Total Electricity Energy consumption for DRI-EAF Steel production w/ 83% H2 and 0% scrap (MWh/metric tonne steel production)
        ...
        greet1 = openpyxl.load_workbook(greet1_ccs_central_h2, data_only=True)
        smr_ccs_NG_consume = (greet1['Hydrogen']['C392'].value * btu_to_MJ * mmbtulhv_per_kg_h2)            # TODO: See GreenHEART_Notes.txt, w/ CCS Natural Gas (NG) consumption (MJ-LHV/kg H2)
        ...
        smr_NG_consume = (greet1['Hydrogen']['C392'].value * btu_to_MJ * mmbtuhhv_per_kg_h2)                # TODO: See GreenHEART_Notes.txt, SMR w/out CCS WTG NG consumption (MJ-HHV/kg H2)
        smr_RNG_consume = (greet1['Hydrogen']['L392'].value * btu_to_MJ * mmbtuhhv_per_kg_h2)               # TODO: See GreenHEART_Notes.txt, SMR w/out CCS WTG RNG consumption (MJ-HHV/kg H2)
        smr_NG_PO_consume = (greet1['Hydrogen']['C389'].value * btu_to_kWh * mmbtuhhv_per_kg_h2)            # TODO: See GreenHEART_Notes.txt, greet value = 10.02, SMR via NG w/out CCS WTG Total Energy consumption (kWh/kg H2)
        smr_RNG_PO_consume = (greet1['Hydrogen']['L389'].value * btu_to_kWh * mmbtuhhv_per_kg_h2)           # TODO: See GreenHEART_Notes.txt, SMR via RNG w/out CCS WTG Total Energy consumption (kWh/kg H2)
        smr_steam_prod = (greet1['Inputs']['I1105'].value * btu_to_MJ * mmbtulhv_per_kg_h2)                 # SMR Steam exported w/out CCS (MJ/kg H2)
        atr_NG_consume = (greet1['Hydrogen']['N392'].value * btu_to_MJ * mmbtuhhv_per_kg_h2)                # TODO: See GreenHEART_Notes.txt, same value as w/ CCS enabled, no pathway for ATR w/out CCS, ATR w/out CCS WTG NG consumption (MJ-HHV/kg H2)
        atr_RNG_consume = (greet1['Hydrogen']['O392'].value * btu_to_MJ * mmbtuhhv_per_kg_h2)               # TODO: See GreenHEART_Notes.txt, same value as w/ CCS enabled, no pathway for ATR w/out CCS, ATR w/out CCS WTG RNG consumption (MJ-HHV/kg H2)
        atr_NG_PO_consume = (greet1['Hydrogen']['N389'].value * btu_to_kWh * mmbtuhhv_per_kg_h2)            # TODO: See GreenHEART_Notes.txt, same value as w/ CCS enabled, no pathway for ATR w/out CCS, ATR via NG w/out CCS WTG Total Energy consumption (kWh/kg H2)
        atr_RNG_PO_consume = (greet1['Hydrogen']['O389'].value * btu_to_kWh * mmbtuhhv_per_kg_h2)           # TODO: See GreenHEART_Notes.txt, same value as w/ CCS enabled, no pathway for ATR w/out CCS # ATR via RNG w/out CCS WTG Total Energy consumption (kWh/kg H2)
        greet1.close()
        ...
        #TODO: Confirm X_PO_consume values with Masha
